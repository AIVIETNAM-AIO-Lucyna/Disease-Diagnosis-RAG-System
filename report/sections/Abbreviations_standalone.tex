% =====================================================================
%  Danh mục từ viết tắt - BẢN ĐỘC LẬP (tự biên dịch ra PDF)
%  Med_Pharm_Bio_Nexus - AI Conquer 2026
%
%  Biên dịch bằng XeLaTeX (khuyến nghị) hoặc LuaLaTeX để hiển thị tiếng Việt.
%  Trên Overleaf: Menu -> Compiler -> chọn XeLaTeX, đặt file này làm Main document.
% =====================================================================
\documentclass[11pt]{article}

\usepackage{fontspec}          % dùng với XeLaTeX/LuaLaTeX cho tiếng Việt

...
\textbf{(C) Tính nhất quán hạ tầng (offline vs OpenSearch):} chênh lệch Hit@1 giữa Python thuần và OpenSearch live (mẫu 5k) nhỏ và giữ nguyên thứ hạng phương pháp (Bảng \ref{tab:livevsoffline}), củng cố độ tin cậy của logic truy xuất.

...
% [Phụ trách: Nguyễn Thị Diễm Hương.]
% Nguồn số liệu: Bảng~\ref{tab:offline} (offline, n=132,448);
% experiments/exp02/results/exp02_per_disease.csv (per-disease BM25);
% experiments/exp02/results/live_eval_latest.json (OpenSearch full run 26/06).
% MSR và Bootstrap CI dưới đây tính trực tiếp từ per-disease BM25; đã đối chiếu
% khớp Hit@1 (98.47% / 98.78%) và MRR (0.9921 / 0.9937) với Bảng~\ref{tab:offline}.

...
\usepackage{pgfplots}
% ---- Bổ sung gói cho table, align footnoot tốt hơn
...
\begin{appendices}
  \begin{enumerate}
    ...
    \item \textbf{Demo Video:} \url{https://youtu.be/KHQy3MPnzCc}. Video trình bày chi tiết về kiến trúc tổng thể, luồng xử lý dữ liệu, và biểu diễn trực tiếp quá trình truy xuất trên OpenSearch.
  \end{enumerate}

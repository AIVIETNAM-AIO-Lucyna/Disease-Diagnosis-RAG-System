...
\input{sections/sec01_tomtat}
\newpage
\setcounter{tocdepth}{2}
\tableofcontents
\thispagestyle{fancy}
\newpage
\input{sections/sec02_gioithieu}
\input{sections/sec03_baitoan}
\input{sections/sec04_relatedwork}
\input{sections/sec05_phuongphap}
\input{sections/sec06_experiments}
\input{sections/sec07_ketqua}
\input{sections/sec08_ablation}
\input{sections/sec09_thaoluan}
\input{sections/sec10_loihanche}
\input{sections/sec11_phase2}
\input{sections/sec12_teamops}
\input{sections/sec13_tailap}
\input{sections/sec14_ketluan}
\newpage
...
\item \textbf{Experiment Logs:} EXP-01 (offline) và EXP-02 (offline, $n=132{,}448$) cùng lần chạy thử OpenSearch live (25/06, mẫu 5.000) được ghi đầy đủ trên Notion (Experiment \& Logs).
